        ...
        <div className="wd-dashboard-course">
          ...
          >
            ...
            <div>
              ...
              <p className="wd-dashboard-course-title">Flutes, specifically </p>
              <button> Go</button>
            </div>
          </Link>
        </div>
        ...
        <div className="wd-dashboard-course">
          ...
          >
            ...
            <div>
              ...
              <p className="wd-dashboard-course-title">Explosions </p>
              <button> Go</button>
            </div>
          </Link>
        </div>
        <div className="wd-dashboard-course">
          ...
          >
            <img
              ...
              alt={"Totoro amigurumi"}
              width={200}
            />
            <div>
              <h5> CS6789 Crochet </h5>
              <p className="wd-dashboard-course-title">Creating Amigurumi </p>
              <button> Go</button>
            </div>
          </Link>
        </div>
