    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Open packet of sausage.</li>
          <li>Heat up skillet.</li>
          <li>
            Cook until browned and 165 degrees fahrenheit internal temperature.
          </li>
        </ol>
      ...
      <br />
      Please
      <a href="https://github.com/Anzhuo-W/kambaz-react-web-app" id="wd-github">
        {" "}
        click here{" "}
      </a>
      to go to the github repo for source code
      <br />
    </div>
  );
}
